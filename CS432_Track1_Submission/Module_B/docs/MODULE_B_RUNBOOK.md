...
Run the SQL inspection commands described in `evidence/DB_EVIDENCE/README.md` and refresh the text files if the package is being rebuilt.
...
```powershell
node reports/index_benchmark.js > ..\..\evidence\BENCHMARK_EVIDENCE\01_benchmark_results.txt
```
