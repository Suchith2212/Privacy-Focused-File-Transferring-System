...
ROOT = Path("CS432_Track1_Submission/Module_A")
REPORT_PATH = ROOT / "report.ipynb"
DOMAIN_PATH = ROOT / "integration" / "benchmark_blinddrop_paths.json"
DETAILED_PATH = ROOT / "evidence" / "benchmark_detailed.json"
COMBINED_RESULTS_PATH = ROOT / "evidence" / "07_module_a_benchmark_results.json"
BENCHMARK_SUMMARY_PATH = ROOT / "evidence" / "08_module_a_benchmark_summary.md"
EVIDENCE_SUMMARY_PATH = ROOT / "evidence" / "13_module_a_evidence_summary.md"
...
- `benchmark_memory_after_delete.png`: retained structure size after deleting **{delete_percent}%** of keys
