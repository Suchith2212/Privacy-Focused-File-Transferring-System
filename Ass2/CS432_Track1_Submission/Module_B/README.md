...
- `docs/`
  Technical documentation, final report, and end-to-end runbook.
- `logs/`
  Packaged `audit.log` artifact for submission review.
- `evidence/`
  Organized proof folders for API behavior, database state, audit logs, and benchmarking.
- `report.ipynb`
  Jupyter notebook version of the Module B report.

## Recommended reading order

1. [report.ipynb](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_B/report.ipynb)
2. [MODULE_B_FINAL_REPORT.md](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_B/docs/MODULE_B_FINAL_REPORT.md)
3. [MODULE_B_COMPLIANCE_CHECKLIST.md](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_B/docs/MODULE_B_COMPLIANCE_CHECKLIST.md)
4. [PROJECT_DOCUMENTATION.md](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_B/docs/PROJECT_DOCUMENTATION.md)
5. [MODULE_B_RUNBOOK.md](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_B/docs/MODULE_B_RUNBOOK.md)
6. `evidence/API_EVIDENCE/`
7. `evidence/DB_EVIDENCE/`
8. `evidence/AUDIT_LOG_EVIDENCE/`
9. `evidence/BENCHMARK_EVIDENCE/`
...
- SQL schema folder: [`sql/init_schema.sql`](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_B/sql/init_schema.sql)
- Auth middleware: [`authSession.js`](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_B/app/backend/src/middleware/authSession.js)
- Protected CRUD routes: [`portfolio.js`](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_B/app/backend/src/routes/portfolio.js)
- Admin-only tamper check: [`security.js`](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_B/app/backend/src/routes/security.js)
- EXPLAIN and timing benchmark: [`index_benchmark.js`](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_B/app/backend/reports/index_benchmark.js)
- Compliance map: [`MODULE_B_COMPLIANCE_CHECKLIST.md`](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_B/docs/MODULE_B_COMPLIANCE_CHECKLIST.md)
...
- [app.js](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_B/app/frontend/app.js)
...
- [api_response_benchmark.js](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_B/app/backend/reports/api_response_benchmark.js)
