...
RAW_PATH = BENCH_DIR / "01_benchmark_results.txt"
JSON_PATH = BENCH_DIR / "07_benchmark_results.json"
CSV_PATH = BENCH_DIR / "08_benchmark_comparison.csv"
SUMMARY_PATH = BENCH_DIR / "02_benchmark_summary.md"
PLAN_TABLE_PATH = BENCH_DIR / "06_explain_plan_table.md"
TIME_PLOT_PATH = BENCH_DIR / "03_duration_comparison.png"
SPEEDUP_PLOT_PATH = BENCH_DIR / "04_speedup_comparison.png"
ROWS_PLOT_PATH = BENCH_DIR / "05_rows_examined.png"
    ...
    SUMMARY_PATH.write_text(
        "\n".join(
            [
                "# Benchmark Summary",
                "",
                "This summary was generated from the packaged `01_benchmark_results.txt` snapshot.",
                "",
                "## Result table",
                "",
