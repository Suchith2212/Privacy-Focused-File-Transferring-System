...
- `docs/`
  Submission-facing explanation documents.
- `evidence/`
  Console outputs, JSON outputs, benchmark summaries, and plot artifacts prepared for submission.
- `report.ipynb`
...
1. `report.ipynb`
2. [docs/MODULE_A_INTEGRATION_REPORT.md](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_A/docs/MODULE_A_INTEGRATION_REPORT.md)
3. [docs/15_MODULE_A_INTEGRATION_SUMMARY.md](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_A/docs/15_MODULE_A_INTEGRATION_SUMMARY.md)
4. [database/README.md](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_A/database/README.md)
5. [integration/README.md](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_A/integration/README.md)
6. [evidence/README.md](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_A/evidence/README.md)
...
| Submission evidence | `evidence/` and `integration/*.md` |
...
- [bplustree.py](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_A/database/bplustree.py)
- [bruteforce.py](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_A/database/bruteforce.py)
- [table.py](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_A/database/table.py)
- [db_manager.py](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_A/database/db_manager.py)
- [blinddrop_index_manager.py](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_A/integration/blinddrop_index_manager.py)
- [blinddrop_index_demo.py](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_A/integration/blinddrop_index_demo.py)
- [db_index_parity_demo.py](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_A/integration/db_index_parity_demo.py)
- [benchmark_blinddrop_paths.py](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_A/integration/benchmark_blinddrop_paths.py)
- [benchmark_detailed.py](/F:/SEM%20IV/lessons/DB/Project/CS432_Track1_Submission/Module_A/integration/benchmark_detailed.py)
