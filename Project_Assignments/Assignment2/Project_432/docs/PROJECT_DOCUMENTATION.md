# BlindDrop Project Documentation

This document matches the current `Project_432` implementation and its Module B alignment layer.

## 1) Architecture

- Backend: Node.js + Express
- Database: MySQL (`blinddrop_proto`)
- Storage: Google Drive for BlindDrop file blobs
...
BlindDrop access in the browser still uses:
...
- [init_schema.sql](/F:/SEM%20IV/lessons/DB/Project/Project_Assignments/Assignment2/Project_432/backend/sql/init_schema.sql)

### BlindDrop Core Tables
...
- Used for SUB token display/recovery in the BlindDrop UI
...
- [audit.log](/F:/SEM%20IV/lessons/DB/Project/Project_Assignments/Assignment2/Project_432/backend/logs/audit.log)
...
- [index_benchmark.js](/F:/SEM%20IV/lessons/DB/Project/Project_Assignments/Assignment2/Project_432/backend/reports/index_benchmark.js)
- [optimization_report.md](/F:/SEM%20IV/lessons/DB/Project/Project_Assignments/Assignment2/Project_432/backend/reports/optimization_report.md)
...
- legacy BlindDrop routes remain available

## 12) Run Instructions

```powershell
cd Project_432/backend
...
- [app.js](/F:/SEM%20IV/lessons/DB/Project/Project_Assignments/Assignment2/Project_432/backend/src/app.js)
- [auth.js](/F:/SEM%20IV/lessons/DB/Project/Project_Assignments/Assignment2/Project_432/backend/src/routes/auth.js)
- [portfolio.js](/F:/SEM%20IV/lessons/DB/Project/Project_Assignments/Assignment2/Project_432/backend/src/routes/portfolio.js)
- [security.js](/F:/SEM%20IV/lessons/DB/Project/Project_Assignments/Assignment2/Project_432/backend/src/routes/security.js)
- [authSession.js](/F:/SEM%20IV/lessons/DB/Project/Project_Assignments/Assignment2/Project_432/backend/src/services/authSession.js)
- [portfolioIntegrity.js](/F:/SEM%20IV/lessons/DB/Project/Project_Assignments/Assignment2/Project_432/backend/src/services/portfolioIntegrity.js)
- [fileAuditLogger.js](/F:/SEM%20IV/lessons/DB/Project/Project_Assignments/Assignment2/Project_432/backend/src/services/fileAuditLogger.js)
- [init_schema.sql](/F:/SEM%20IV/lessons/DB/Project/Project_Assignments/Assignment2/Project_432/backend/sql/init_schema.sql)
- [index.html](/F:/SEM%20IV/lessons/DB/Project/Project_Assignments/Assignment2/Project_432/frontend/index.html)
- [app.js](/F:/SEM%20IV/lessons/DB/Project/Project_Assignments/Assignment2/Project_432/frontend/app.js)
- [styles.css](/F:/SEM%20IV/lessons/DB/Project/Project_Assignments/Assignment2/Project_432/frontend/styles.css)
