...
The standalone B+ Tree in `Module_A/database/` already satisfies the core assignment requirement. The purpose of this folder is to show how that same tree can be reused as a project-shaped index over Ghost Drop-style data.
